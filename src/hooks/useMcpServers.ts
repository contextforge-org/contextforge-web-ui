 ...
 * useMcpServers (#5842).
 *
 * Polls `GET /v1/mcp-servers` (React "MCP servers") for the home MCP reachability
 ...
 *
 * The backend RBAC-scopes `/v1/mcp-servers` (`gateways.read` + token-team scoping), so
...
const MCP_SERVERS_PATH = "/v1/mcp-servers?limit=100&include_inactive=true&include_pagination=true";

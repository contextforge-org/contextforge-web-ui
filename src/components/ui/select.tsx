...
// Height as a CVA variant (not a data-[size=*] selector): an attribute
// selector's specificity always beats a plain utility class regardless of
// source order, so a call-site "h-10" could never override it. A variant
// puts the height back in the same className string tailwind-merge dedupes.

        ...
        <div className="flex items-center justify-between gap-3 px-3 py-2">
          ...
          <div className="flex items-center gap-1 rounded-full bg-muted p-1">
            <Button
              ...
              className={`rounded-full transition-colors ${theme === "light" ? "bg-background text-foreground ring-1 ring-border" : "text-muted-foreground hover:text-foreground"}`}
            ...
            <Button
              ...
              className={`rounded-full transition-colors ${theme === "dark" ? "bg-background text-foreground ring-1 ring-border" : "text-muted-foreground hover:text-foreground"}`}
            ...
            <Button
              ...
              className={`rounded-full transition-colors ${theme === "system" ? "bg-background text-foreground ring-1 ring-border" : "text-muted-foreground hover:text-foreground"}`}
